// app/(dashboard)/vendors/[vendorId]/products/new/page.tsx
"use client";
...
const NewVendorProductPage = () => {
  ...
  useEffect(() => {
    const checkPermissions = async () => {
      try {
        ...
        console.log("Checking vendor permissions for products:", {
        ...
        setError("You don't have permission to create products for this vendor");
        setLoading(false);
  ...
  return <ProductForm vendorId={params.vendorId as string} />;
};
